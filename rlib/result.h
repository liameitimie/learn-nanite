...
// template<typename T, typename CleanT=typename std::decay<T>::type>
// result_types::Ok<CleanT> Ok(T&& val){
//     return result_types::Ok<CleanT>(std::forward<T>(val));
// }

// inline result_types::Ok<void> Ok(){
//     return result_types::Ok<void>();
// }

// template<typename E, typename CleanE=typename std::decay<E>::type>
// result_types::Err<CleanE> Err(E&& val){
//     return result_types::Err<CleanE>(std::forward<E>(val));
// }

// template<typename T,typename E>
// struct Result{
//     Result(result_types::Ok<T> ok){
//         this->ok_=true;
//         this->value.val=ok.val;
//     }

//     Result(result_types::Err<E> err){
//         this->ok_=false;
//         this->error.val=err.val;
//     }

//     Result(const Result& other){
//         if (other.is_ok()){
//             value.val=other.value.val;
//             ok_=true;
//         }else{
//             error.val=other.error.val;
//             ok_=false;
//         }
//     }
...
//             return value.val;
//         }
//         std::fprintf(stderr,"called `Result::unwrap()` on an `Err` value\n");
//         std::terminate();
//     }
...
//             return error;
//         }
//         std::fprintf(stderr,"called `Result::unwrap_err()` on an `Ok` value\n");
//         std::terminate();
//     }

// private:
//     union{
//         result_types::Ok<T> value;
//         result_types::Err<E> error;
//     };
//     bool ok_;
// };
